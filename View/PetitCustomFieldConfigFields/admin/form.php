...
<table cellpadding="0" cellspacing="0" class="form-table bca-form-table section">
	<tr id="Row<?php echo $currentModelName . Inflector::camelize('name'); ?>">
		<th class="col-head bca-form-table__label">
			<?php echo $this->BcForm->label('PetitCustomFieldConfigField.name', 'カスタムフィールド名') ?>&nbsp;<?php if($customFieldConfig['isNewThemeAdmin']): ?><span class="required bca-label" data-bca-label-type="required">必須</span><?php else: ?><span class="required">*</span><?php endif ?>
		</th>
	...
	<tr id="Row<?php echo $currentModelName . Inflector::camelize('label_name'); ?>">
		<th class="col-head bca-form-table__label">
			<?php echo $this->BcForm->label('PetitCustomFieldConfigField.label_name', 'ラベル名') ?>&nbsp;<?php if($customFieldConfig['isNewThemeAdmin']): ?><span class="required bca-label" data-bca-label-type="required">必須</span><?php else: ?><span class="required">*</span><?php endif ?>
		</th>
		<td class="col-input bca-form-table__input" colspan="3">
	...
	<tr id="Row<?php echo $currentModelName . Inflector::camelize('field_name'); ?>">
		<th class="col-head bca-form-table__label">
			<?php echo $this->BcForm->label('PetitCustomFieldConfigField.field_name', 'フィールド名') ?>&nbsp;<?php if($customFieldConfig['isNewThemeAdmin']): ?><span class="required bca-label" data-bca-label-type="required">必須</span><?php else: ?><span class="required">*</span><?php endif ?>
		</th>
		<td class="col-input bca-form-table__input" colspan="3">
	...
	<tr id="Row<?php echo $currentModelName . Inflector::camelize('field_type'); ?>">
		<th class="col-head bca-form-table__label">
			<?php echo $this->BcForm->label('PetitCustomFieldConfigField.field_type', 'フィールドタイプ') ?>&nbsp;<?php if($customFieldConfig['isNewThemeAdmin']): ?><span class="required bca-label" data-bca-label-type="required">必須</span><?php else: ?><span class="required">*</span><?php endif ?>
		</th>
		<td class="col-input bca-form-table__input" colspan="3">
	...
	<tr id="Row<?php echo $currentModelName . Inflector::camelize('status'); ?>">
		...
		<td class="col-input bca-form-table__input" id="Row<?php echo $currentModelName . Inflector::camelize('required'); ?>" colspan="3">
	...
	<tr id="Row<?php echo $currentModelName . Inflector::camelize('validate'); ?>Group">
		...
		<td class="col-input bca-form-table__input">
			...
			<div id="PetitCustomFieldConfigFieldValidateRegexBox" class="display-none" style="clear: both;">
				<?php echo $this->BcForm->label('PetitCustomFieldConfigField.validate_regex', '正規表現入力') ?>&nbsp;<?php if($customFieldConfig['isNewThemeAdmin']): ?><span class="required bca-label" data-bca-label-type="required">必須</span><?php else: ?><span class="required">*</span><?php endif ?>
...
<div class="submit bca-actions">
	...
	<span class="bca-actions__sub">
		<?php $this->BcBaser->link('削　除',
			...
			array('class' => 'btn-gray button bca-btn', 'id' => 'BtnDelete', 'data-bca-btn-size' => 'sm', 'data-bca-btn-color' => 'danger' , 'data-bca-btn-type' => 'delete'),
