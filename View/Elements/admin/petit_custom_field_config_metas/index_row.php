...
<tr<?php echo $class ?>>
	<td class="row-tools">
	<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_unpublish.png', array('width' => 24, 'height' => 24, 'alt' => '項目を無効', 'class' => 'btn')),
	...
	<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_publish.png', array('width' => 24, 'height' => 24, 'alt' => '項目を有効', 'class' => 'btn')),
	...
	<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_manage.png', array('width' => 24, 'height' => 24, 'alt' => '所属グループ管理', 'class' => 'btn')),
			array('controller' => 'petit_custom_field_config_metas', 'action' => 'edit',
					$data['PetitCustomFieldConfigMeta']['id']), array('title' => '所属グループ管理')) ?>

	<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_edit.png', array('width' => 24, 'height' => 24, 'alt' => '項目を編集', 'class' => 'btn')),
	...
	<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_delete.png', array('width' => 24, 'height' => 24, 'alt' => '項目を削除', 'class' => 'btn')),
	...
	<?php if ($this->request->params['pass']): ?>
		<?php if ($count != 1 || !isset($datas)): ?>
			<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_up.png', array('width' => 24, 'height' => 24, 'alt' => '項目を上へ移動', 'class' => 'btn')),
		...
		<?php if (!isset($datas) || count($datas) != $count): ?>
			<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_down.png', array('width' => 24, 'height' => 24, 'alt' => '項目を下へ移動', 'class' => 'btn')),
